...
let iconMenu = document.querySelector(".icon-menu");
     hiddenMenu = document.querySelectorAll(".hiddenMenu");
if (iconMenu != null) {
	let delay = 500;
...
let popupOrder = document.querySelector('.popup_popup');
let orderBtn = document.querySelectorAll('._order');
...
orderBtn.forEach((e)=>{
  e.addEventListener('click', ()=>{
    popupOrder.classList.add('_active');
})
})
...
let myImageSlider = new Swiper('.product__slider', {
	// Стрелки
	navigation: {
		nextEl: '.slider__next',
		prevEl: '.slider__prev'
